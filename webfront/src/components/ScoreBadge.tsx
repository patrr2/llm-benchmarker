...
export const ScoreBadge = (props: { details?: string | null, llmName: string; score: number | boolean | null; }) => {
    ...
    return (
        <div className="inline-block bg-gray-900 py-1 p-2 rounded-lg" title={props.details ?? "[no details given]"}>
            <b>{props.llmName}</b>
